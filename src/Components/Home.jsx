        ...
        <>
            ...
            <div className="recent-container flex flex-col pt-10 justify-center items-center text-center gap-5">
                ...
                <div className="recent-cards pb-10 grid grid-cols-3 gap-5">
                    {allBids.map((allBid) => (
                        <div key={allBid._id} className="recent-card">
                            <img
                            ...
                            <div className="flex justify-around w-full">
                                <h4 className="flex justify-center items-center gap-1 font-bold pt-5">
                                    <FaCircleNodes></FaCircleNodes>
                                    {allBid.title}
                                </h4>
                                <h4 className="flex justify-center items-center gap-1 font-medium pt-5">
                            ...
                            <div className="flex justify-around w-full pb-5">
                                <h1 className="flex justify-center items-center gap-1 font-medium pt-5">
